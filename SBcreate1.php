...
$sql2 = mysqli_query($connect,"select user from bear where user='$qid'");
...
<br>
<input type='text' name='buser' placeholder='Username' autocomplete='off' required />
<br>
<input type='password' name='pass' placeholder='Password' required />
<br>
<input type='text' name='fname' placeholder='First Name' autocomplete='off' required />
<br>
<input type='text' name='gname' placeholder='Last Name' autocomplete='off' required />
<br>
<input type='text' name='email' placeholder='Student Email' autocomplete='off' required />
<br>
